...
public class FieldReportService {
    ...
    @Transactional
    public FieldReport submit(FieldReportRequest request, Profile submittedBy) {
    ...
    @Transactional
    public List<FieldReport> syncBatch(List<FieldReportRequest> requests, Profile submittedBy) {
