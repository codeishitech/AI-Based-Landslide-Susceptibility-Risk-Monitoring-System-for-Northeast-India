...
import com.ner.landslide.security.CustomUserDetailsService;
...
/**
 * Stateless JWT-based security configuration implementing the role-based
 * access control matrix from the README (CITIZEN / FIELD_OFFICER /
